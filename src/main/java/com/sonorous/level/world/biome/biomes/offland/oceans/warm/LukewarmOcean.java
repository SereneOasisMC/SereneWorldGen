...
public class LukewarmOcean extends BiomeRepresentation {
    ...
    public LukewarmOcean() {
        super(org.bukkit.block.Biome.LUKEWARM_OCEAN, "Lukewarm Ocean", layers, -0.2, -0.8, 0.4, BiomeCategories.OFF);
    }
}
