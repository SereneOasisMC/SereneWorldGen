package com.sonorous.level.world.biome.biomes.offland.oceans.cold;
...
public class FrozenOcean extends BiomeRepresentation {

    private static final HashMap<BiomeLayers, List<Material>> layers = new HashMap<>() {{
        put(BiomeLayers.SURFACE, List.of(Material.ICE, Material.WATER, Material.WATER, Material.WATER));
    ...
    public FrozenOcean() {
        super(org.bukkit.block.Biome.FROZEN_OCEAN, "Frozen Ocean", layers, -1.0, -0.8, -0.7, BiomeCategories.OFF);
    }
}
